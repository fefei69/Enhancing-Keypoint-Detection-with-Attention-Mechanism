...
class DreamNetwork:
    def __init__(self, network_config):
        ...
        vgg_list = ["vgg","vgg_att","vgg_attlast","vgg_mha","vgg_transformer"]
        if self.architecture_type in vgg_list :
            vgg_kwargs = {}
            ...
            vgg_kwargs["model_type"] = self.architecture_type
            ...
            if "n_stages" in self.network_config["architecture"]:
                ...
                print("######################################")
                print("DreamHourglassMultiStage model loaded")
            else:
                self.model = torch.nn.DataParallel(
                ...
                print("######################################")
                print("DreamHourglass model loaded")
