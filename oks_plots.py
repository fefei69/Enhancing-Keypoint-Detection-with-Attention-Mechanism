...
#--show --output "vgg_f_mha_0605_PCK" --colours 0 1 2 3 4 --labels "vgg_f" "vgg_f_mha" "vgg_f_attlast" "vgg_f_transformer" "vgg_f_transformer_mha" 
...
ax.legend(loc="lower right", frameon=True, fancybox=True, framealpha=0.8, fontsize=12)
...
plt.grid()
plt.savefig(f"results/{args.output}")
if args.show:
    plt.show()
